      ...
      <section className="data-management" aria-labelledby="data-management-title">
        ...
        <div className="data-action danger-action">
          <div>
            ...
            <p>Restore Day, Task, Mastery, Study Time, and settings. Notes and Projects are kept.</p>
          </div>
          <button
        ...
        {showResetConfirmation ? (
          ...
          >
            ...
            <p id="reset-confirmation-description">Your tasks, mastery status and study time will be cleared. Notes and Projects will be kept.</p>
            <div>
              <button
                disabled={isResetting}
                onClick={() => {
        ...
        <p className="data-warning">Import replaces Task, Mastery, Study Time, current Day, Notes, and Projects data after confirmation.</p>
